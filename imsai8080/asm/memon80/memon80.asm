...
;    JAIR 8080 CPU Board's serial ports
...
RAMEND	equ	0F7FFh	;Last allowed RAM address for MEMON/80.
...
CJAIR	equ	FALSE	;JAIR 8080 CPU (serial port A or B)
...
TISIO2B	equ	TRUE	;IMSAI SIO-2 Port B
...
TJAIR	equ	FALSE	;JAIR 8080 CPU (serial port A or B)
...
;                            Port B   01h    & 80h-82h
;
; JAIR 8080 CPU		     Port A   20h     20h-2Fh
;			     Port B   28h
;
...
TBASE	equ	004h	;Transfer Port base address
...
VERSA2  equ     TRUE	;SD Sales Versafloppy II
...
;--------------------------------------------------------------
DIBASE	equ	060h	;Disk Controller I/O Base Address
...
;REVISION HISTORY
;
;Version 3.06  M. Douglas 30 October 2025
;  Add support for the serial ports on the JAIR 8080 CPU board
;
...
;JAIR 8080 CPU Board
;
;The JAIR 8080 board has 2 serial ports that are
;each based on the Intel 8250 UART.
;--------------------------------------------------
 if CJAIR
C8250	set	TRUE
CB8250	equ	CBASE
