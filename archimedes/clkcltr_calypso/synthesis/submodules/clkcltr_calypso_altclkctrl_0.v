...
module  clkcltr_calypso_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //clkcltr_calypso_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clkcltr_calypso_altclkctrl_0  (
    ena,
    inclk,
    outclk);
...
`endif
    ...
    clkcltr_calypso_altclkctrl_0_sub  clkcltr_calypso_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
