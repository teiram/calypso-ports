...
derive_pll_clocks
create_generated_clock -name sdclk_pin -source [get_pins {pll|altpll_component|auto_generated|pll1|clk[0]}] [get_ports {SDRAM_CLK}]
...
set_multicycle_path -from [get_clocks {sdclk_pin}] -to [get_clocks {pll|altpll_component|auto_generated|pll1|clk[0]}] -setup -end 2
