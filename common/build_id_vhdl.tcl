proc generateBuildID_VHDL {} {
	...
	set outputFileName "build_id.vhdl"
	set outputFile [open $outputFileName "w"]

	# Output the VHDL source
	puts $outputFile "package calypso_version is"
	puts $outputFile "    constant BUILD_DATE: string := \"$buildDate\";"
	puts $outputFile "    constant BUILD_TIME: string := \"$buildTime\";"
	puts $outputFile "    constant BUILD_VERSION: string := \"calypso-$version\";"
	puts $outputFile "end package;"
	close $outputFile
